...
module.exports = {
  compileStage() {
    ...
    const userCFTemplate = this.serverless.service.resources.Resources;
    ...
    if (logs || TracingEnabled || Tags.length > 0) {
      ...
      if (logs && (!userCFTemplate[logGroupLogicalId] || !userCFTemplate[logsRoleLogicalId] || !userCFTemplate[accountLogicalid])) {
        // --- currently commented out since this is done via the SDK in updateStage.js ---
